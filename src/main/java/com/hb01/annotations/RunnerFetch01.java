...
//		} 
		...
		//HQL örneği---sql sorgusunda from'dan sonra sınıf ismi kullanılır
		//kullanılmazsa student01 is not mapped hatası olınır
...
//		}
		...
		//dönecek kaydın unique olduğuna eminseniz uniqueResult kullanılır
...
//		System.out.println(uniqueResult2);
		...
		//Grade değeri 11 olan öğrencileri getir
//		String hqlQuery3="select s.id,s.name from Student01 s where s.grade=11";
